...
if (isset($_POST['username'], $_POST['password'], $_POST['name'], $_FILES['photo'])) {
    ...
    if (empty($passwd)) $passwdError = "Password is required";
    if (strlen($passwd) < 6) $passwdError = "Password must be at least 6 characters";
    if (usernameExist($username)) $usernameError = "Username is currently unavailable!";
        ...
        try {
            if (createUser($name, $username, $passwd, $photo)) {
                ...
                echo '<div class="alert alert-success" role="alert">
                        User created successfully! <a href="./?page=user/list">Go to list</a>
                      </div>';
            } else {
...
<form method="post" action="./?page=register" class="col-md-8 col-lg-6 mx-auto" enctype="multipart/form-data">
    ...
    <div class="d-flex justify-content-center">
        ...
        <label role="button" for="profileUpload">
            <img src="<?php echo handleUserlogin()->photo ?? './assets/images/emptyuser.png' ?>"
